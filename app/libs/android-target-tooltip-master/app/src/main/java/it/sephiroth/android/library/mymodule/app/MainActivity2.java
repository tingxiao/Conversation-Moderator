    ...
    private void test() {
        ...
        Tooltip.make(
            ...
            new Tooltip.Builder(101)
                ...
                .text("Tooltip on activity_summary TabLayout child...")
                .fadeDuration(200)
                .fitToScreen(false)
                .maxWidth(400)
                .showDelay(400)
                ...
                if (null == tooltip) {
                    ...
                    tooltip = Tooltip.make(
                        ...
                        new Tooltip.Builder()
                            ...
                            .closePolicy(mClosePolicy, 5000)
                            .text("LEFT. Touch None, so the tooltip won't disappear with activity_summary touch, but with activity_summary delay")
                            .withArrow(false)
                            .withOverlay(false)
                            .maxWidth(metrics.widthPixels / 3)
                            .showDelay(300)
